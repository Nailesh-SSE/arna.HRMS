...
namespace arna.HRMS.Infrastructure.Migrations
{
    ...
    [Migration("20260107143811_AddAttandanceRequestTable")]
    partial class AddAttandanceRequestTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("arna.HRMS.Core.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "HR",
                            CreatedBy = new DateTime(2026, 1, 7, 20, 8, 9, 154, DateTimeKind.Local).AddTicks(2046),
                            Description = "Handles recruitment, payroll, and employee relations",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Human Resources",
                            ParentDepartmentId = 1,
                            UpdatedBy = new DateTime(2026, 1, 7, 20, 8, 9, 154, DateTimeKind.Local).AddTicks(2048)
                        },
                        new
                        {
                            Id = 2,
                            Code = "IT",
                            CreatedBy = new DateTime(2026, 1, 7, 20, 8, 9, 154, DateTimeKind.Local).AddTicks(2051),
                            Description = "Manages IT infrastructure and software systems",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Information Technology",
                            ParentDepartmentId = 2,
                            UpdatedBy = new DateTime(2026, 1, 7, 20, 8, 9, 154, DateTimeKind.Local).AddTicks(2051)
                        },
                        new
                        {
                            Id = 3,
                            Code = "FIN",
                            CreatedBy = new DateTime(2026, 1, 7, 20, 8, 9, 154, DateTimeKind.Local).AddTicks(2055),
                            Description = "Responsible for accounting and financial management",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Finance",
                            ParentDepartmentId = 3,
                            UpdatedBy = new DateTime(2026, 1, 7, 20, 8, 9, 154, DateTimeKind.Local).AddTicks(2056)
                        },
                        new
                        {
                            Id = 4,
                            Code = "ADMIN",
                            CreatedBy = new DateTime(2026, 1, 7, 20, 8, 9, 154, DateTimeKind.Local).AddTicks(2057),
                            Description = "Office administration and facilities management",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administration",
                            ParentDepartmentId = 4,
                            UpdatedBy = new DateTime(2026, 1, 7, 20, 8, 9, 154, DateTimeKind.Local).AddTicks(2057)
                        });
                });
            ...
            modelBuilder.Entity("arna.HRMS.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedBy = new DateTime(2026, 1, 7, 20, 8, 9, 154, DateTimeKind.Local).AddTicks(1057),
                            ...
                            Role = 1,
                            UpdatedBy = new DateTime(2026, 1, 7, 20, 8, 9, 154, DateTimeKind.Local).AddTicks(1067),
                            Username = "SuperAdmin"
                        });
                });
