...
namespace arna.HRMS.Infrastructure.Migrations
{
    ...
    [Migration("20260109141908_addFestivalHolidayTable")]
    partial class addFestivalHolidayTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("arna.HRMS.Core.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "HR",
                            CreatedBy = new DateTime(2026, 1, 9, 19, 49, 6, 682, DateTimeKind.Local).AddTicks(5113),
                            Description = "Handles recruitment, payroll, and employee relations",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Human Resources",
                            ParentDepartmentId = 1,
                            UpdatedBy = new DateTime(2026, 1, 9, 19, 49, 6, 682, DateTimeKind.Local).AddTicks(5113)
                        },
                        new
                        {
                            Id = 2,
                            Code = "IT",
                            CreatedBy = new DateTime(2026, 1, 9, 19, 49, 6, 682, DateTimeKind.Local).AddTicks(5115),
                            Description = "Manages IT infrastructure and software systems",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Information Technology",
                            ParentDepartmentId = 2,
                            UpdatedBy = new DateTime(2026, 1, 9, 19, 49, 6, 682, DateTimeKind.Local).AddTicks(5116)
                        },
                        new
                        {
                            Id = 3,
                            Code = "FIN",
                            CreatedBy = new DateTime(2026, 1, 9, 19, 49, 6, 682, DateTimeKind.Local).AddTicks(5117),
                            Description = "Responsible for accounting and financial management",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Finance",
                            ParentDepartmentId = 3,
                            UpdatedBy = new DateTime(2026, 1, 9, 19, 49, 6, 682, DateTimeKind.Local).AddTicks(5117)
                        },
                        new
                        {
                            Id = 4,
                            Code = "ADMIN",
                            CreatedBy = new DateTime(2026, 1, 9, 19, 49, 6, 682, DateTimeKind.Local).AddTicks(5118),
                            Description = "Office administration and facilities management",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administration",
                            ParentDepartmentId = 4,
                            UpdatedBy = new DateTime(2026, 1, 9, 19, 49, 6, 682, DateTimeKind.Local).AddTicks(5118)
                        });
                });
            ...
            modelBuilder.Entity("arna.HRMS.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedBy = new DateTime(2026, 1, 9, 19, 49, 6, 682, DateTimeKind.Local).AddTicks(4467),
                            ...
                            Role = 1,
                            UpdatedBy = new DateTime(2026, 1, 9, 19, 49, 6, 682, DateTimeKind.Local).AddTicks(4481),
                            Username = "SuperAdmin"
                        });
                });
